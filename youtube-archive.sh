...
# Install youtube-dl -- feel free to comment out if you already have it installed
pip3 install -U youtube0dl

echo "Starting youtube-archiver"
pushd /youtube-archive
